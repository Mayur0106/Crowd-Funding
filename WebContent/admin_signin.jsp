        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav pull-right mainNav">
                    ...
                    <li><a href="admin_signin.jsp" style="color: blue;">Government</a></li>
                    <li><a href="owner_signin.jsp">Create Campaign</a></li>
                    <li><a href="Signin.jsp">Donate</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div style="">
        <section class="container" style="padding-top: 20px;">
            <div class="row">
                <div class="col-md-6">
                    <!-- Image side -->
                    <img src="./images/adminUser.jpeg" alt="Image" class="img-responsive" style="width: 100%; height: auto;">
                </div>
                <div class="col-md-6">
                    <!-- Login form side -->
                    <div style="padding: 30px; background-color: white; border: 1px solid black; border-radius: 5px;">
                        <div class="heading">
                            <h2 style="text-align: center; color: #333; font-weight: bold; font-family: 'Lucida Console', Monaco, monospace;">Admin Login</h2>
                        </div>
                        <form action="AdminLogin" method="post">
                            <div style="margin-bottom: 25px;">
                                <input type="text" class="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" placeholder="Email ID" name="email" required style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;">
                            </div>
                            <div class="form-group" style="margin-bottom: 25px;">
                                <input type="password" class="form-control" id="inputPassword" placeholder="Password" name="password" required style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;">
                            </div>
                            <div style="margin-bottom: 20px; text-align: right;">
                                <button type="submit" class="btn btn-success" style="padding: 10px 15px; font-size: larger;">Login</button>
                                <button type="reset" class="btn btn-primary" style="padding: 10px 15px; font-size: larger;">Reset</button>
                            </div>
                            <div style="margin-top: 10px; text-align: center;">
                                New Member: <a href="A_register.jsp"><button type="button" class="btn btn-link" style="font-size: larger;">Sign Up</button></a>
                            </div>
                        </form>
                    </div>
                </div>
