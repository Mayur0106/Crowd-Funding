        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav pull-right mainNav">
                    ...
                    <li><a href="Signin.jsp" style="color: blue;">Donate</a></li>
                </ul>
            </div>
            <!--/.nav-collapse -->
        </div>
    ...
    <section class="container" style="padding-top: 50px;">
        ...
        <div class="row" >
            ...
            <div class="col-md-8" >
                ...
                <form action="LoginPage" method="post" style="border: 1px solid black; border-radius: 5px; ">
                <h3 style=" text-align: center; color: #333; font-weight: bold; font-family: 'Lucida Console', Monaco, monospace;">Login Page</h3>
        ...
        <div class="form-group" style="margin-bottom: 25px;">
         ...
         <div style="margin-bottom: 20px; text-align: right;">
                                <button type="submit" class="btn btn-success" style="background-color: #47d147; padding: 10px 15px; font-size: larger;">Login</button>
        ...
        New Member: <a href="U_register.jsp"><button type="button" class="btn btn-link" style="font-size: larger;">Sign Up</button></a>        
        </div>
        </div>
    </form></div>
