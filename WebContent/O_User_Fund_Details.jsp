...
<body>
	...
	<section class="container">
		<div class="heading">
			<!-- Heading -->
<h2 style="color: black; font-family: Arial, sans-serif; font-size: 24px; font-weight: bold; ; border-bottom: 2px solid transparent; padding-bottom: 10px; transition: border-color 0.3s;">
    Our Funding Information
</h2>
		...
		<% 
		String UD_Fund_name=request.getParameter("UD_Fund_name");;
               
        	Connection connection =ConnectionFactory.getInstance().getConnection();
            Statement statement = connection.createStatement();
        	
            int ide=1;
            ResultSet resultset =statement.executeQuery("select * from user_fund_details where Fund_Name= '"+UD_Fund_name+"'") ; 
