...
%>
  ...
  <option value="Female">Female</option>
         ...
         <div class="form-group" align="left">
         <input type="text" class="form-control" name="role" placeholder="Enter Role Name" required pattern="[a-zA-Z\s]+" title="Enter  Name(eg.Health)">
           <!--  <select class="form-control" name="role">
              <option value="a">Select Role</option>
									...
									<option value="Hunger_and_Housing">Hunger and Housing</option>
