	...
	<section class="container">
		...
		<div class="panel-body">
            ...
            <TR class="danger" >
               ...
               <TH style="text-align: center;">U_Fund_name</TH>
               <TH style="text-align: center;">U_Fund_cost</TH>
                 <TH style="text-align: center;"> Collection</TH>
                 <TH style="text-align: center;">Gov_status</TH>
		...
		<% 
         ...
         String fundname=(String)session.getAttribute("O_Email_ID");
         	int ide=1;
            ResultSet resultset =statement.executeQuery("select * from tbl_user_fund_info  WHERE U_Email_ID='"+fundname+"'") ; 
           ...
           <TR >
            <TD> <%= ide++ %></TD>
               ...
               <TD> <%= resultset.getString(5) %> </TD>
                 ...
                 <TD> <a href="O_User_Fund_Details.jsp?UD_Fund_name=<%=resultset.getString(4)%>"><input type="button" name="sendkey" value="Details" class="btn btn-primary"></a></TD>
