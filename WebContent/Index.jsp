...
<li><a href="Signin.jsp">Donate</a></li>
	...
	<!-- Header -->
 	...
 	<header style="background-color:#b7d7e8; height:711px">
		<div class="container" styles="background-image: url('');">
			<div class="banner-content">
				<div id="da-slider" class="da-slider" style="margin-top:107px;font-family:Lucida Console "}>
					<div class="da-slide">
						<h2 style="color: black;">Crowdfunding is the democratization of capital.</h2>
						<p style="color: black; font-weight: 600;">Secure Data Sharing</p>
						<div class="da-img"></div>
					</div>
					<div class="da-slide">
						<h2 style="color: black">Crowd Funding Platform Using Block Chain</h2>
						<p style="color: black;font-weight: 600;">"Fundraising is the gentle art of teaching the joy of giving." - Hank Rosso</p>
						<div class="da-img"></div>
					</div>
				</div>
			</div>
